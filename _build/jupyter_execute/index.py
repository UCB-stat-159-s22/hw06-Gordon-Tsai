...
from ligotools import readligo as rl, utils
...
for det in dets:
    ...
    if make_plots:
        ...
        utils.plot_ASD(template_fft,datafreq, d_eff, freqs, data_psd, pcolor, det, fs, eventname, plottype, True)
...
fmtcsv = ",".join(["%10.6f"] * 5)
np.savetxt("data/" + fncsv, datcsv, fmt=fmtcsv, header=headcsv)
